                        ...
                        <div class="panel-body">
                            <div class="col-md-8">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="titulo-evento" class="form-control" minlength="5" name="evento.titulo"
                                           type="text" required value="${evento.tipoEsporte.nome}" disabled>
                                    <!--  
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control datePicker" id="dataInicio_evento"
                                           value="${evento.dataInicio}" disabled
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input id="localizacao" class="form-control" name="evento.localizacao" disabled
                                ...
                                <div class="form-group col-md-12 text-center" >
                                    ...
                                    <textarea id="descricao-evento" class="form-control" minlength="5"
                                              name="evento.descricao" rows="5" disabled
                            ...
                            <div class="col-md-4 order-md-2 mb-4">
                                ...
                                <ul class="list-group mb-3">
                                    <c:forEach items="${evento.participantes}" var="participante">
                                        <input type="hidden" value="${participante.id}" name="atleta.id"/>
...
<%--                    <form action="${linkTo[EventoController].convidarAtleta}?id=${evento.id}&login=${atleta.login}" method="post">--%>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a id="btnConvidar" href="#" url-convite="${linkTo[EventoController].convidarAtleta}?id=${evento.id}&login=" class="btn btn-primary">Convidar</a>
                        </div>
                    </div><!-- /.modal-content -->
<%--                    </form>--%>
                </div><!-- /.modal-dialog -->
